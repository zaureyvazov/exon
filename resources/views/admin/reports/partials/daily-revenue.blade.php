<div class="card">
    <div class="card-header bg-success text-white">
        <h5 class="mb-0"><i class="bi bi-calendar-day"></i> Günlük Gəlir Raporu</h5>
    </div>
    <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            <th>CƏMI</th>
                            <th class="text-end">{{ number_format($reportData->sum('revenue'), 2) }} AZN</th>
                            <th class="text-end">{{ number_format($reportData->sum('commissions'), 2) }} AZN</th>
                            <th class="text-end">{{ number_format($reportData->sum('net_profit'), 2) }} AZN</th>
                            <th class="text-center">{{ $reportData->sum('referral_count') }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
